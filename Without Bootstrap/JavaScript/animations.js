...
}, 10000); /// career image changes


setInterval(function(){
    let feed_btn = document.getElementById("feed-btn");
    feed_btn.setAttribute("style" , "transform:scale(1.2); -o-transform:scale(1.2) ; -moz-transform:scale(1.2); -webkit-transform:scale(1.2);");
    setTimeout(function(){
        feed_btn.setAttribute("style" , "transform:scale(1);-o-transform:scale(1) ; -moz-transform:scale(1); -webkit-transform:scale(1);");
    },500);

},1000); /// feedback redirection button animation